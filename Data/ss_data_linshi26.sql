...
) ENGINE=MyISAM AUTO_INCREMENT=189 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';
...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=155 DEFAULT CHARSET=utf8 COMMENT='资金流水表';
...
INSERT INTO `ss_config` VALUES ('40', 'TRANSFER_FEE_RATE', '0', '过户费费率', '0', '', '没一千股1元。交易数量*0.001就行', '1484815787', '1487602193', '1', '0.2', '0');
...
INSERT INTO `ss_config` VALUES ('45', 'BLUE_NUM', '0', '蓝色安全界限', '0', '', '', '1486796503', '1486796503', '1', '70', '0');
...
CREATE TABLE `ss_deal_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='交易流水表';
...
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', 'admin', '1', '2.00', '2.00', '0.00', '0.00', '0.00', '2', '1', '53', '0', '1483858373', '2130706433', '1487593479', '666', '1', '1');
...
CREATE TABLE `ss_profit_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='利息佣金流水表';
...
CREATE TABLE `ss_summary_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='结算流水表';
...
-- ----------------------------
INSERT INTO `ss_ucenter_member` VALUES ('1', 'admin', '781cd47811175f59257e48e39888236b', '494044011@qq.com', '2', '1483858373', '2130706433', '1487593479', '2130706433', '1483858373', '1');
...
INSERT INTO `ss_user` VALUES ('2', '小龙', '30838.50', '2783331.86', '100', '12.00', '1.50', '5.00', '3.00', '1.00', '1', '1', '1', '2', '352619499416584875', '234345@qq.com', '19864598731', '', '0', '2', '2', '上海市#上海市#黄浦区', '江西省#南昌市#市辖区', '福建华南地区', '19864598731', '1', '0', '1');
...
INSERT INTO `ss_user` VALUES ('6', '小东', '0.00', '0.00', '10', '12.00', '10.00', '0.00', '0.00', '0.00', '0', '0', '1', '2', '350729198808122836', '', '12038386767', '', '0', '1', '0', '##', '##', '', '0592-7265488', '1', '1487245663', '1');
INSERT INTO `ss_user` VALUES ('7', 'jack', '0.00', '0.00', '10', '0.80', '0.80', '0.00', '0.00', '0.00', '0', '0', '1', '2', '358674199503039832', '', '', '', '0', '1', '0', '##', '##', '', '', '0', '1487246157', '1');
