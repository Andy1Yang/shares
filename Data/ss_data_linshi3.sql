...
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';
...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='资金流水表';

-- ----------------------------
-- Records of ss_capital_log
-- ----------------------------
INSERT INTO `ss_capital_log` VALUES ('1', '1', '12.00', '1222.00', '222.00', '21312', '3243254', '1', '', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('2', '1', '2324.00', '423432.00', '234.00', '234234', '4235t45', '1', '', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('7', '1', '0.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
INSERT INTO `ss_capital_log` VALUES ('8', '1', '0.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
INSERT INTO `ss_capital_log` VALUES ('9', '1', '0.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
...
-- Records of ss_user
-- ----------------------------
INSERT INTO `ss_user` VALUES ('1', 'test', '1.00', '1.00', '1', '1.00', '1.00', '1.00', '1.00', '1.00', '1', '2', '1', '1', '352648955612487659', '', '18064516574', '0', '1', '1', '', '', '', '', '1', '0', '0');
