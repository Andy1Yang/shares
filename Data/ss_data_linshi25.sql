...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 COMMENT='资金流水表';
...
CREATE TABLE `ss_deal_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='交易流水表';
...
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', 'admin', '1', '2.00', '2.00', '0.00', '0.00', '0.00', '2', '1', '50', '0', '1483858373', '2130706433', '1487429343', '666', '1', '1');
...
CREATE TABLE `ss_profit_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='利息佣金流水表';
...
CREATE TABLE `ss_summary_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='结算流水表';
...
-- ----------------------------
INSERT INTO `ss_ucenter_member` VALUES ('1', 'admin', '781cd47811175f59257e48e39888236b', '494044011@qq.com', '2', '1483858373', '2130706433', '1487429343', '2130706433', '1483858373', '1');
...
INSERT INTO `ss_user` VALUES ('2', '小龙', '20000.00', '1861538.76', '100', '12.00', '1.50', '5.00', '3.00', '1.00', '1', '1', '1', '2', '352619499416584875', '234345@qq.com', '19864598731', '', '0', '2', '2', '上海市#上海市#黄浦区', '江西省#南昌市#市辖区', '福建华南地区', '19864598731', '1', '0', '1');
...
INSERT INTO `ss_user` VALUES ('7', 'jack', '0.00', '0.00', '10', '12.00', '12.00', '0.00', '0.00', '0.00', '0', '0', '1', '2', '358674199503039832', '', '', '', '0', '1', '0', '##', '##', '', '', '0', '1487246157', '1');
