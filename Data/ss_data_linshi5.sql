...
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';
...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='资金流水表';
...
CREATE TABLE `ss_deal_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='交易流水表';

-- ----------------------------
-- Records of ss_deal_log
-- ----------------------------
INSERT INTO `ss_deal_log` VALUES ('1', '1', '0323', '林南科技', '1', '1', '1', '12.00', '23.00', '11.00', '1.00', '2.00', '2.00', '4294967295', '2', '1', '', '2');
...
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', 'admin', '1', '2.00', '2.00', '0.00', '0.00', '0.00', '2', '1', '13', '0', '1483858373', '2130706433', '1484207896', '666', '1');
...
-- ----------------------------
INSERT INTO `ss_ucenter_member` VALUES ('1', 'admin', '781cd47811175f59257e48e39888236b', '494044011@qq.com', '2', '1483858373', '2130706433', '1484207896', '2130706433', '1483858373', '1');
...
-- Records of ss_user
-- ----------------------------
INSERT INTO `ss_user` VALUES ('1', 'test', '101.10', '111.00', '100', '1.00', '1.00', '1.00', '1.00', '1.00', '1', '2', '1', '1', '352648955612487659', '', '18064516574', '0', '1', '1', '##', '##', '', '', '1', '0', '0');
