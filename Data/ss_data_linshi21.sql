...
) ENGINE=MyISAM AUTO_INCREMENT=142 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';
...
INSERT INTO `ss_auth_group` VALUES ('4', 'admin', '1', '营业二部', '', '1', '1,3,26,108,109,219,220,221,222,223,224,225,226,227,228,231,232,237,238,240,241,243,244,245,246,247,248,249');
...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='资金流水表';
...
CREATE TABLE `ss_deal_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='交易流水表';
...
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', 'admin', '1', '2.00', '2.00', '0.00', '0.00', '0.00', '2', '1', '32', '0', '1483858373', '2130706433', '1486698585', '666', '1', '1');
...
INSERT INTO `ss_member` VALUES ('7', '颐和园', '8', '1.00', '1.00', '0.00', '0.00', '0.00', '18064516571', '1', '14', '0', '0', '2130706433', '1485054543', '1', '3', '1');
...
CREATE TABLE `ss_profit_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='利息佣金流水表';
...
CREATE TABLE `ss_summary_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='结算流水表';
...
INSERT INTO `ss_summary_log` VALUES ('8', '0', '2', '0', '300219', '鸿利智汇', '93920.00', '10.00', '95400.00', '239.58', '1666.520', '-436.10', '1486264967', '1486264975', '1', '6', '8000', '12.00', '0.00', '95.40', '2.00', '153.00', '0', '0.00', '0.00', '0.00', '0.00', '0', '0.00', '21', '0', '0');
...
INSERT INTO `ss_summary_log` VALUES ('27', '0', '2', '0', '000002', '万科A', '20680.00', '32.02', '21000.00', '52.70', '200.000', '35.28', '1486274240', '1486274273', '1', '6', '1000', '21.00', '0.00', '21.00', '1.00', '31.50', '1486264979', '20.68', '0.00', '1.00', '31.02', '1000', '20712.02', '1', '0', '0');
...
-- ----------------------------
INSERT INTO `ss_ucenter_member` VALUES ('1', 'admin', '781cd47811175f59257e48e39888236b', '494044011@qq.com', '2', '1483858373', '2130706433', '1486698585', '2130706433', '1483858373', '1');
...
INSERT INTO `ss_ucenter_member` VALUES ('7', '颐和园', '6ec54e53f6f2f8bdbddd32179d123d4b', '', '18064516571', '0', '0', '1485054543', '2130706433', '0', '1');
...
INSERT INTO `ss_user` VALUES ('2', '小龙', '15642.14', '1481935.99', '100', '12.00', '1.50', '5.00', '3.00', '1.00', '1', '1', '1', '2', '352619499416584875', '234345@qq.com', '19864598731', '0', '2', '2', '上海市#上海市#黄浦区', '江西省#南昌市#市辖区', '福建华南地区', '19864598731', '1', '0', '1');
