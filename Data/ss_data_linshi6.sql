...
CREATE TABLE `ss_capital_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='资金流水表';

-- ----------------------------
-- Records of ss_capital_log
-- ----------------------------
INSERT INTO `ss_capital_log` VALUES ('1', '1', '12.00', '1222.00', '222.00', '21312', '3243254', '1', '', '1', '3');
INSERT INTO `ss_capital_log` VALUES ('2', '1', '2324.00', '423432.00', '234.00', '234234', '4235t45', '1', '', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('7', '1', '111.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
INSERT INTO `ss_capital_log` VALUES ('8', '1', '0.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
INSERT INTO `ss_capital_log` VALUES ('9', '1', '2222.00', '0.00', '0.00', '0', '', '0', '', '0', '0');
INSERT INTO `ss_capital_log` VALUES ('10', '1', '101.00', '101.00', '100.00', '1484137800', 'JY201701112042', '1', 'ww', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('11', '1', '101.00', '101.00', '100.00', '1484137800', 'JY201701112046', '1', 'ss', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('12', '1', '201.00', '10101.00', '100.00', '1484137800', 'JY201701112051', '1', 'ee', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('13', '1', '301.00', '20101.00', '100.00', '1484137860', 'JY201701112052', '1', 'ff', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('14', '1', '201.00', '10101.00', '100.00', '1484141400', 'JY201701112155', '1', 'test', '2', '1');
INSERT INTO `ss_capital_log` VALUES ('15', '1', '101.00', '101.00', '100.00', '1484143532', 'JY201701112206', '1', '33', '2', '1');
INSERT INTO `ss_capital_log` VALUES ('16', '1', '101.10', '0.00', '0.00', '0', '', '1', '', '1', '3');
INSERT INTO `ss_capital_log` VALUES ('17', '1', '201.10', '10111.00', '100.00', '1484228787', 'JY201701122146', '1', '3334', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('18', '1', '201.10', '10000.00', '101.00', '1484228814', 'JY201701122149', '1', '的', '5', '1');
INSERT INTO `ss_capital_log` VALUES ('19', '1', '251.10', '15000.00', '50.00', '1484228948', 'JY201701122150', '1', '元', '1', '1');
INSERT INTO `ss_capital_log` VALUES ('20', '1', '250.00', '14890.00', '1.10', '1484229047', 'JY201701122152', '1', '3334', '2', '1');
INSERT INTO `ss_capital_log` VALUES ('21', '1', '250.00', '14320.00', '570.00', '1484229275', 'JY201701122156', '1', '收', '5', '1');
...
CREATE TABLE `ss_deal_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='交易流水表';

-- ----------------------------
-- Records of ss_deal_log
-- ----------------------------
INSERT INTO `ss_deal_log` VALUES ('1', '1', '0323', '林南科技', '1', '1', '1', '12.00', '23.00', '11.00', '1.00', '2.00', '2.00', '1294967295', '2', '1', '', '2');
INSERT INTO `ss_deal_log` VALUES ('7', '1', '123456', '中石化', '1', '2', '10', '10.10', '5.00', '3.00', '1.00', '1.00', '101.00', '1484228814', '1', '1', '的', '2');
INSERT INTO `ss_deal_log` VALUES ('8', '1', '123456', '中石化', '1', '2', '4800', '0.10', '30.00', '40.00', '10.00', '10.00', '480.00', '1484229275', '1', '1', '收', '2');
...
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', 'admin', '1', '2.00', '2.00', '0.00', '0.00', '0.00', '2', '1', '14', '0', '1483858373', '2130706433', '1484231583', '666', '1');
...
-- ----------------------------
INSERT INTO `ss_ucenter_member` VALUES ('1', 'admin', '781cd47811175f59257e48e39888236b', '494044011@qq.com', '2', '1483858373', '2130706433', '1484231583', '2130706433', '1483858373', '1');
...
INSERT INTO `ss_user` VALUES ('2', '小龙', '0.00', '0.00', '1:100', '2.00', '3.00', '100000.00', '200000.00', '300.00', '2', '2', '1', '2', '352619499416584875', '234345@qq.com', '19864598731', '0', '2', '2', '上海市#上海市#黄浦区', '江西省#南昌市#东湖区', '福建华南地区', '19864598731', '1', '0', '1');
