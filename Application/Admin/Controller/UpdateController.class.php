...
class UpdateController extends AdminController{
	...
	private function update($version){
		...
		$this->showMsg('系统原始版本:'.股票管理平台_VERSION);
		$this->showMsg('股票管理平台在线更新日志：');
		...
		/* 获取更新包 */
		//获取更新包地址
		$updatedUrl = 'http://www.股票管理平台.cn/index.php?m=home&c=check_version&a=getDownloadUrl';
		$params = array('version' => 股票管理平台_VERSION);
		...
		$file = str_replace(股票管理平台_VERSION, $version, $file);
