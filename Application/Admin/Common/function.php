 ...
 * @param $uid
 */
//function get_left_menu_sales($uid,$controller){
//
//    $salesList = M('sales')->where('1=1')->field('id,title')->select();
//    $data = [];
//    foreach($salesList as $item){
//        $res = M('user')->where('sales_id='.$item['id'])->field('id,name as title')->select();
