...
return array(
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX'    => '股票管理平台_', // 缓存前缀
    ...
    'UPLOAD_QINIU_CONFIG'=>array(
        ...
        'bucket'=>'股票管理平台test',
        'domain'=>'股票管理平台test.u.qiniudn.com',
        'timeout'=>3600,
    ),
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => '股票管理平台_admin', //session前缀
    'COOKIE_PREFIX'  => '股票管理平台_admin_', // Cookie前缀 避免冲突
	...
	/*聚合数据-股票api 配置*/
	'JH_APPKEY' => 'e2b809cd2059dcb53f59faa01b8e523b',
);
