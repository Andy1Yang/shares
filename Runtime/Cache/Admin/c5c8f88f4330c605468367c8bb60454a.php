...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="nickname" value="<?php echo ($_res["nickname"]); ?>">
                <input type="hidden" name="uid" value="<?php echo ($_res["uid"]); ?>">
                <input type="hidden" name="is_eidt" value="1">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">佣金提成比例<span class="check-tips">（%）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="yonjin_rate" value="<?php echo ($_res["yonjin_rate"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">利息提成比例</label>
            <div class="controls">
                <input type="text" class="text input-large" name="lixi_rate" value="<?php echo ($_res["lixi_rate"]); ?>">
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="level" id="">
                    <option value="1" <?php if(($_res["level"] == 1)): ?>selected='selected'<?php endif; ?>>老板</option>
                    <option value="2" <?php if(($_res["level"] == 2)): ?>selected='selected'<?php endif; ?>>主管</option>
                    <option value="3" <?php if(($_res["level"] == 3)): ?>selected='selected'<?php endif; ?>>普通业务员</option>
                </select>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="sex" id="">
                    <option value="1" <?php if(($_res["sex"] == 1)): ?>selected='selected'<?php endif; ?>>男</option>
                    <option value="2" <?php if(($_res["sex"] == 2)): ?>selected='selected'<?php endif; ?>>女</option>
                </select>
            </div>
        </div>
        <div class="form-item">
