...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fl cf">
            <div class="sleft">
                <span>股票代码: <input type="text" name="shares_code" value="<?php echo ($shares_code); ?>"></span>&nbsp;&nbsp;
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('position');?>" style="float:right;"><i class="btn-search"></i></a>
            </div>
        </div>
        <!--div class="fl">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Report/position');?>');
    </script>
