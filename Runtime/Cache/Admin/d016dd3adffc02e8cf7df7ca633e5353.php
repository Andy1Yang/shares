...
<body>
    ...
    <div class="data-table table-striped" >
        <table class="">
            ...
            <?php if(!empty($_deal_list)): if(is_array($_deal_list)): $i = 0; $__LIST__ = $_deal_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo (date('Y-m-d',$vo["deal_time"])); ?></td>
                        ...
                        <td><?php if($vo['do_type'] == 1): echo ($vo['deal_money']+$vo['commission']+$vo['entrust_fee']+$vo['transfer_fee']+$vo['stamp_duty']); else: ?>0.00<?php endif; ?></td>
                        <td><?php if($vo['do_type'] == 1): echo ($_days); else: ?>0<?php endif; ?></td>
                        <td><?php if($vo['do_type'] == 1): echo ($_summary["interest"]); else: ?>0.00<?php endif; ?></td>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        var id = <?php echo ($_summary["user_id"]); ?>;
