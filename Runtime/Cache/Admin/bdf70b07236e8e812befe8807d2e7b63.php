...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fl cf">
            <div class="sleft">
                <span>查询时间：<input class="Wdate" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo ($start); ?>" name="start">至：<input class="Wdate" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo ($end); ?>"  name="end"></span>&nbsp;&nbsp;
                营业部门：
                ...
                <select name="member_id" id="member_id">
                    <option value="">--请选择--</option>
                    <?php if(is_array($_memberList)): $i = 0; $__LIST__ = $_memberList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$me): $mod = ($i % 2 );++$i;?><option style="display:none" said="<?php echo ($me["sales_id"]); ?>" value="<?php echo ($me["uid"]); ?>" <?php if($me['uid'] == $member_id): ?>selected='selected'<?php endif; ?>><?php echo ($me["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('layer');?>" style="float:right;"><i class="btn-search"></i></a>
            </div>
        </div>
        <!--div class="fl">
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <tbody>
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i; if(is_array($vos)): $i = 0; $__LIST__ = $vos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vo["nickname"]); ?> </td>
                        <td><?php echo ($vo["name"]); ?></td>
                        <td><?php echo ($vo["rate"]); ?></td>
                        <td><?php echo ($vo["dali_rate"]); ?></td>
                        <td><?php echo ($vo["total_interest"]); ?></td>
                        <td><?php echo ($vo["profit_interest"]); ?></td>
                        <td><?php echo ($vo["lixi_rate"]); ?></td>
                        <td><?php echo ($vo["interest_ticheng"]); ?></td>
                        <td><?php echo ($vo["yonjin_rate"]); ?></td>
                        <td><?php echo ($vo["daili_yongjin_rate"]); ?></td>
                        <td><?php echo ($vo["total_yongjin"]); ?></td>
                        <td><?php echo ($vo["profit_yongjin"]); ?></td>
                        <td><?php echo ($vo["yonjin_rate"]); ?></td>
                        <td><?php echo ($vo["yonjin_ticheng"]); ?></td>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Report/layer');?>');
    </script>
