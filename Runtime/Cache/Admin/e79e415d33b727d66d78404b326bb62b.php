...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">保证金<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="ensure_money" value="<?php echo ($_res["ensure_money"]); ?>">
        ...
        <div class="form-item">
            <label class="item-label">可用资金<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="able_money" value="<?php echo ($_res["able_money"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">发生金额<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="happen_money" value="<?php echo ($_res["happen_money"]); ?>">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">交易编码</label>
            <div class="controls">
                <input type="text" class="text input-large" name="deal_code" value="<?php echo ($_res["deal_code"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">操作备注</label>
            <div class="controls">
                <input type="text" class="text input-large" name="remarks" value="<?php echo ($_res["remarks"]); ?>">
            </div>
        </div>
        <div class="form-item">
