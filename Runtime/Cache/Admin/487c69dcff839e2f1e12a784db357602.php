    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["return_interest"]); ?></td>
                        <!--td><?php echo ($vo["status_text"]); ?></td-->
                        <td>
                            <?php if(($vo['status'] == 1)): ?><!--a class="bigbutton sell" href="<?php echo U('returnInterest?id='.$vo['id']).'&user_id='.$_uid.'&startTime='.$_startTime.'&endTime='.$_endTime;?>">返息</a-->
                            <a href="<?php echo U('returnInterest?id='.$vo['id'].'&user_id='.$_uid.'&startTime='.$_startTime.'&endTime='.$_endTime);?>" class="ajax-get bigbutton">返息</a>
                            <?php else: ?>
                                <span>已返息</span><?php endif; ?>
                        </td>
                        <td>
                            <?php if(($vo['update_time'] != 0)): echo (time_format($vo["update_time"])); endif; ?>
                        </td>
