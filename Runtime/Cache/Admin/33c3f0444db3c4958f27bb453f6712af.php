...
<body>
        ...
        <div class="cf">
            ...
            <div class="search-form fl cf">
                <div class="sleft">
                    ...
                    <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('accounts');?>" style="float:right;"><i class="btn-search"></i></a>
                </div>
            </div>
            <!--div class="fl">
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["total_profit"]); ?></td>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Report/accounts');?>');
    </script>
