...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">买入金额<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="buy_money" value="<?php echo ($_res["buy_money"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">买入费用</label>
            <div class="controls">
                <input type="text" class="text input-large" name="buy_cost" value="<?php echo ($_res["buy_cost"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">卖出金额</label>
            <div class="controls">
                <input type="text" class="text input-large" name="sell_money" value="<?php echo ($_res["sell_money"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">卖出费用</label>
            <div class="controls">
                <input type="text" class="text input-large" name="sell_cost" value="<?php echo ($_res["sell_cost"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">利息</label>
            <div class="controls">
                <input type="text" class="text input-large" name="interest" value="<?php echo ($_res["interest"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">盈亏金额</label>
            <div class="controls">
                <input type="text" class="text input-large" name="win_loss" value="<?php echo ($_res["win_loss"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">卖出时间</label>
            <div class="controls">
                <input type="text" class="text input-large" name="sell_time" value="<?php echo (date('Y-m-d H:i:s',$_res["sell_time"])); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">操作时间</label>
            <div class="controls">
                <input type="text" class="text input-large" name="do_time" value="<?php echo (date('Y-m-d H:i:s',$_res["do_time"])); ?>">
            </div>
        </div>
        <div class="form-item">
