...
<body>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo U('sales_add');?>">新 增</a>
            <button class="btn ajax-post confirm" url="<?php echo U('sales_del');?>" target-form="ids">删 除</button>
        </div>
    </div>
    <!-- 数据列表 -->
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('User/sales_edit?id='.$vo['id']);?>" class="authorize">修改</a>
                            <a href="<?php echo U('User/sales_del?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                        </td>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('User/asles_list');?>');
    </script>
