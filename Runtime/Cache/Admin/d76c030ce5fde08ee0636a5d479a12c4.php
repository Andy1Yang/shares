...
<body>
        ...
        <div class="search-form fl cf">
            <div class="sleft">
                ...
                客户：<select name="user_id" id="user_id">
                        <option value="">--请选择--</option>
                    <?php if(is_array($_userList)): $i = 0; $__LIST__ = $_userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$me): $mod = ($i % 2 );++$i;?><option value="<?php echo ($me["id"]); ?>" <?php if($me['id'] == $user_id): ?>selected='selected'<?php endif; ?>><?php echo ($me["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('deal');?>" style="float:right;"><i class="btn-search"></i></a>
            </div>
        </div>
        <div class="fl">
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["win_loss"]); ?></td>
                        <td><span><?php echo (time_format($vo["sell_time"])); ?></span></td>
                        <td><?php echo ($vo["sell_amount"]); ?></td>
                        <td><?php echo ($vo["sell_deal_price"]); ?></td>
                        <td><?php echo ($vo["sell_money"]); ?></td>
                        <td><?php echo ($vo["sell_transfer_fee"]); ?></td>
                        <td><?php echo ($vo["sell_commission"]); ?></td>
                        <td><?php echo ($vo["sell_stamp_duty"]); ?></td>
                        <td><?php echo (time_format($vo["buy_time"])); ?></td>
                        <td><?php echo ($vo["buy_amount"]); ?></td>
                        <td><?php echo ($vo["buy_deal_price"]); ?></td>
                        <td><?php echo ($vo["buy_money"]); ?></td>
                        <td><?php echo ($vo["buy_transfer_fee"]); ?></td>
                        <td><?php echo ($vo["buy_commission"]); ?></td>
                        <td><?php echo ($vo["occupy_money"]); ?></td>
                        <td><?php echo ($vo["occupy_day"]); ?></td>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Report/deal');?>');
        //拓宽
        $('#main').css('float','left');
    </script>
