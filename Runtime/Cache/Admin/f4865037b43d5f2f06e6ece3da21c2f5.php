...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fl cf">
            <div class="sleft">
                ...
                <option value="">--请选择--</option>
                <option value="1" <?php if(1 == $type): ?>selected='selected'<?php endif; ?>>存入保证金</option>
                <option value="2" <?php if(2 == $type): ?>selected='selected'<?php endif; ?>>保证金取现</option>
                <option value="3" <?php if(3 == $type): ?>selected='selected'<?php endif; ?>>盈亏转本金</option>
                <option value="4" <?php if(4 == $type): ?>selected='selected'<?php endif; ?>>月底返息</option>
                <option value="5" <?php if(5 == $type): ?>selected='selected'<?php endif; ?>>买入</option>
                <option value="6" <?php if(6 == $type): ?>selected='selected'<?php endif; ?>>卖出</option>
                <option value="7" <?php if(7 == $type): ?>selected='selected'<?php endif; ?>>盈亏结现</option>
            </select>
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('cpital');?>" style="float:right;"><i class="btn-search"></i></a>
            </div>
        </div>
        <!--div class="fl">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Report/cpital');?>');
    </script>
